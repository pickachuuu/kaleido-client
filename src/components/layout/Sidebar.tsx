...
export default function Sidebar() {
    ...
    return (
        <aside className="w-16 lg:w-64 h-full p-4 flex items-center justify-center transition-all duration-300">
                ...
                {sidebarNavItems.map((item) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <span className="hidden lg:inline text-xl">{item.title}</span>
                        </Link>
                    )
                })}
